...
class ViewController: UIViewController {
    ...
    @objc func showTheLove(gesture: UITapGestureRecognizer?) {
        let heartFrame = CGRect(x: 0, y: 0, width: HeartAttributes.heartSize, height: HeartAttributes.heartSize)
        let heart = HeartView(frame: heartFrame)
